...
const NewLanding = () => {
  ...
  useEffect(() => {
    // Check if user has visited before to skip animation
    ...
    // Simple cursor functionality - no hover effects
    function initializeCursor() {
      ...
      // Mouse move handler - simple tracking only
    ...
    // Start terminal preloader animation for first-time visitors
